...
export const transferTokenTransationDetail = async (instruction: ParsedInstruction, meta: ParsedTransactionMeta | null, blockTime: number, signature: string) => {
    ...
    const amount = await getAmount(instruction, token?.decimals || 0);
